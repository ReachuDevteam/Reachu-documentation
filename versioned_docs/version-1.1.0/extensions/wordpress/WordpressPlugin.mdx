...
The “Outshifter Blocks” plugin lets Channels connect their WordPress with
Outshifter to start selling products.

</font>

## Introduction

Outshifter is the API for product data access. Channels can use Outshifter to
get access to product data from multiple Suppliers.

The
“[Outshifter Blocks](https://wordpress.org/plugins/outshifter-embed-commerce/)”
