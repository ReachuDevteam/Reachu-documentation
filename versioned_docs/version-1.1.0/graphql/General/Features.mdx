...
- **Catalogs**: Find and select products from your Outshifter Catalog, using
  filters.
- **Product data**: Acquire data and detailed information about the selected
  products.
...
- **Notifications**: Trigger email notifications to Customers when a new order
  or order status is changed.
