      ...
      line_items: [
        {
          ...
          quantity: 1,
          variant_id: null,
          shipping_id: product.productShipping[0]?.shipping?.id,
          price_data: {
...
Note that we have added a default shipping_id to the product. The customer will
be able to update it at the checkout.
...
For each product, you can set one as default and to update it to a new one you
can use the shopCart.cartItem.update sdk feature.

This change will also automatically trigger a change in the checkout shipping
price so you can update it in your front-end.
  ...
  return (
    <div>
      ...
      <div className="flex justify-center">
        <a href="/" className="mt-16 rounded bg-black py-4 px-12 text-white">
          Continue shoping
        </a>
      </div>
    </div>
  ...
  return (
    <>
      ...
      <div className="text-center">
        <a href="/" className="rounded bg-black py-4 px-12 text-white">
          Continue shoping
        </a>
      </div>
    </>
