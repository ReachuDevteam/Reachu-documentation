...
This section outlines how to delete a previously applied discount code using the
deleteAppliedDiscount() method provided by the SDK. This method is used to
remove a discount code from a shopping cart. It accepts an object with two
properties: code (the discount code) and cartId (the ID of the cart from which
