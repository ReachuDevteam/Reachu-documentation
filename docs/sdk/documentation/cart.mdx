...
updating the cart shipping country.
...
## Update item shipping class or quantity

It is mandatory to assign a shipping class to a product. You can easily do it
after you have assigned a shipping country to the cart. You can get the shipping
id from the product_available_shippings parameter available in the cart items of
the cart.
