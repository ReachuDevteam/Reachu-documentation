...
If you have not created your seller yet, please refer to [User Creation](https://app.gitbook.com/o/I1VOeCf1Kk9QYomzSAiO/s/z9iM6vbFkU4ylWcyVMCY/getting-started/api-key-authentication).

## Customers

As a sales channel, you will be dealing with the creation and management of the final customer. You can create your own sign up or just use it for  purposes.
