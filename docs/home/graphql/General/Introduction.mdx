...
- Introduction: A general explanation of what you will find in this documentation.
- Features: Learn what's included in our GraphQL API for Channels.
- GraphQL: A brief introduction to GraphQL, how we retrieve data through our API, and where to go for more resources.

### Getting Started

Start touching the code - play, learn, and set up the installation.

- Overview: Best practices to start using the Outshifter GraphQL API for Channels.
- Architecture: How the main solution is organized and structured, and where the GraphQL API finds its place.
...
- Products: Retrieve multiple or just a single product from your Outshifter Catalog.
