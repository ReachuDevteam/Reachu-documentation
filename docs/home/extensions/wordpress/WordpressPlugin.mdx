...
The “Outshifter Blocks” plugin lets Channels connect their WordPress with Outshifter to start selling products.
...
<div class="homepage-section two-cols">
 <div class="section-content"> 
  ...
  <div class="card-content">
    <div class="imagelogo"><img alt="" src="https://s.w.org/favicon.ico?2"/></div>
...
The **Outshifter API Key** can be obtained by [logging](https://app.outshifter.com/login) in to your Outshifter account.
