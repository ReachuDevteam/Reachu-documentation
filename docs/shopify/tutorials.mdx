...
In order to import products to your Shopify store, the first step you must
...
- [ ] Once in Channels you must add a new channel to your Reachu account. In
      this case select the **Shopify Channel**
...
Shopify store, you need to sync it. To do this you must do the following:
...
The products will then automatically appear in your Shopify store.
