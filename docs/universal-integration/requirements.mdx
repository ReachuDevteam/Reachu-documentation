...
For a safe integration process, all setup and testing should be conducted in a
development environment, not in live production. Deployment in the production
environment should only be performed after successful testing. This approach
minimizes risks and ensures a smoother transition.
