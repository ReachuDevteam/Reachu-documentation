...
- [WooCommerce Integration Guide](https://support.reachu.io/en/articles/7546308-setting-up-reachu-with-woocommerce)
- [Magento Integration Guide](https://support.reachu.io/en/articles/8075180-how-to-connect-to-magento-adobe-commerce)
...
Please note that at this time, our primary method for data synchronization is
through webhooks. If your ecommerce system does not support webhooks and you
require polling instead, we encourage you to contact our development team for
further assistance. We understand the importance of flexibility in integration
methods and are here to support your needs.
