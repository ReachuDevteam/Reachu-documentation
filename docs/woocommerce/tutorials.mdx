...
In order to import products to your WooCommerce store, the first step you must
...
- [ ] Once in Channels you must add a new channel to your Reachu account. In
      this case select the **WooCommerce Channel**
...
In order for the products that you've added to your channel to show up in your
WooCommerce store, you need to sync it. To do this you must do the following:

- [ ] Go to the section called **Channels**

- [ ] Click on the **WooCommerce Channel**

There you will see all the collections and products that you have added. You
will notice that each one of them has a button called **Sync**, this will allow
you to synchronize your products and export them to your online store.

- [ ] Click on the sync button and wait for the synchronization to be
      successful. You will be shown a message when the process is finished.

The products will then automatically appear in your WooCommerce store.

:::info

Please note that if the product does not appear in your WooCommerce immediately,
