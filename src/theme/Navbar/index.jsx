      ...
      >
        <div className="navbar-top-row">
          <a href="/" className="navbar-brand">
            {colorMode === 'dark' ? (
              <img src="/logo/dark.svg" alt="Logo" className="navbar-logo" />
            ) : (
              <img src="/logo/light.svg" alt="Logo" className="navbar-logo" />
            )}
          </a>
          ...
          <div className="navbar-top-right">
            ...
            <button onClick={toggleColorMode} className="custom-btn-toogle">
              {colorMode === 'dark' ? (
